    ...
    if(typeof(jQuery) == 'undefined' || parseFloat(jQuery.fn.jquery) < REQUIRED_JQUERY){ // jQuery has not been loaded
        ...
        if(!widget_loaded){
            ...
            jQuery('#mount').live('change',function(){
                    ...
                    jQuery.get('https://curtapi.curtmfg.com/v2/GetYear?callback=loadYears',get_data,function(years){},'jsonp');
                    if(mount == 'rear'){
            ...
            jQuery('label[for=year] #year').live('change',function(){
                    ...
                    jQuery.get('https://curtapi.curtmfg.com/v2/GetMake?callback=loadMakes',get_data,function(makes){},'jsonp');
            ...
            jQuery('#make').live('change',function(){
                    ...
                    jQuery.get('https://curtapi.curtmfg.com/v2/GetModel?callback=loadModels',get_data,function(models){},'jsonp');
                    var str = jQuery('#searchStr').text();
            ...
            jQuery('#model').live('change',function(){
                    ...
                    jQuery.get('https://curtapi.curtmfg.com/v2/GetStyle?callback=loadCurtStyles',get_data,function(styles){},'jsonp');
                    var str = jQuery('#searchStr').text();
            ...
            jQuery('#lookup_submit').live('click',function(){
                if(jQuery('#style').get().length !== 0 && jQuery('#style').val() != style && jQuery('#style').val().length > 0){
                    ...
                    jQuery.get('https://curtapi.curtmfg.com/v2/GetParts?callback=loadParts',get_data,function(parts){},'jsonp');
                }
              return false;
            });
...
function loadConfigurator(){
    ...
    if(jQuery('#configurator').length > 0){
        ...
        $.get('https://curtapi.curtmfg.com/v2/AddDeployment?url='+deplyed_location,function(){},'jsonp');
    }
}
...
function showPart(partID){
    if(partID > 0){
        ...
        jQuery.get('https://curtapi.curtmfg.com/v2/GetPart?callback=loadSingle',get_data,function(part_result){},'jsonp');
    }
}
...
function GetAccessories(partID){
    ...
    jQuery.get('https://curtapi.curtmfg.com/v2/GetRelatedParts?callback=loadAccessories',get_data,function(){},'jsonp');
}
...
function displayWiring(){
    ...
    jQuery.get('https://curtapi.curtmfg.com/v2/GetConnector?callback=loadVehicleRecord',get_data,function(){},'jsonp');
}
